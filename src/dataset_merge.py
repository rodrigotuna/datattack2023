...
def add_weekday():
    #read the data_2016.csv file
    ocorrencias = pd.read_csv('../data/data_2016_densidade.csv', sep = ',')

    #add a column with the day of the week
    ocorrencias['DataOcorrencia'] = pd.to_datetime(ocorrencias['DataOcorrencia'], format='%d/%m/%Y %H:%M:%S')
    ...
    #save the merged file
    ocorrencias.to_csv('../data/data_2016_densidade_weekday.csv', index=False)
